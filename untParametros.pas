...
begin
     ...
     cbxDBCS.Hint :=              'Indicar ao compilador que a Code Page especificada '+#13+
                                  'contém caracteres do conjunto de caracteres double-byte (DBCS)';
